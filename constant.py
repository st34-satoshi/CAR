...
# environment
environment = 'torus'  # choose 'torus' , 'square' or 'circle '
...
cop_radius_direction = 10  # the size of the 'eye' of cop
cop_color = pygame.color.Color('red')  # the color of the cop
cop_color_direction = pygame.color.Color('green')  # the color of the cop 'eye'
cop_max_speed = 2  # cops speed
# robber
robbers_number = 1  # there are this number robbers
robber_radius = 20  # the size of robbers.
robber_radius_direction = 10  # the size of the robber 'eye'
robber_color = pygame.color.Color('blue')  # the color of the robber
robber_color_direction = pygame.color.Color('yellow')  # the color of the robber 'eye'
